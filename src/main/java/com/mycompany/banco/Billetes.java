...
public class Billetes {
    ...
    // Constructor
    public Billetes(int billete500, int billete200, int billete100, int billete50, int billete20, int billete10, int billete5) {
    ...
    public void transferirBilletes(Billetes cuentaDestino, int cantidad, Login login) {
        int cantidadTransferida = 0;

        User usuarioActual = App.login.currentUser;

        if (usuarioActual.getSaldo() >= cantidad) {
            ...
            if (cantidadTransferida > 0) {
                ...
                System.out.println(cantidadTransferida + " en billetes de diferentes denominaciones a la cuenta destino.");
            } else {
